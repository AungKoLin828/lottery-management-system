    ...
    >
      ...
      <span
        className={`transition-all duration-200 ${
          active
            ? "text-white"
            : "text-slate-400 group-hover:scale-110 group-hover:text-indigo-300"
        }`}
      >
        {icon}
      </span>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-[72px] items-center justify-between">
            ...
            <div className="hidden items-center gap-2 md:flex">
              ...
              <Link
                to="/login"
                className="rounded-xl px-4 py-2.5 text-sm font-semibold text-slate-300 transition-all duration-200 hover:bg-indigo-500/15 hover:text-white"
              >
                Login
              </Link>
              ...
              <Link
                to="/register"
                className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 px-4 py-2.5 text-sm font-bold text-white shadow-md shadow-indigo-900/30 transition-all duration-200 hover:-translate-y-0.5 hover:from-indigo-500 hover:to-violet-500 hover:shadow-lg hover:shadow-indigo-900/40"
              >
          ...
          >
            <div className="rounded-2xl border border-slate-700 bg-slate-800 p-2 shadow-lg shadow-slate-950/20">
              <nav className="space-y-1">
                ...
                <div className="rounded-xl bg-slate-900 p-1 shadow-sm">
                  <button
                    type="button"
                    onClick={() =>
                  ...
                  {playMenuOpen && (
                    <div className="mt-1 space-y-1 border-t border-slate-700 pt-1">
                      ...
                      <button
                        ...
                        className="group flex w-full items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-semibold text-slate-300 transition-all hover:bg-indigo-500/15 hover:text-indigo-300"
                      >
                      ...
                      <button
                        ...
                        className="group flex w-full items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-semibold text-slate-300 transition-all hover:bg-violet-500/15 hover:text-violet-300"
                      >
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 border-t border-slate-700 pt-3">
                {/* Login */}

                <Link
                  to="/login"
                  onClick={closeMobileMenu}
                  className="flex items-center justify-center rounded-xl border border-slate-600 bg-slate-900 px-4 py-3 text-sm font-bold text-slate-300 transition-all hover:border-indigo-500 hover:bg-indigo-500/15 hover:text-indigo-300"
                >
                  Login
                </Link>
                ...
                <Link
                  to="/register"
                  onClick={closeMobileMenu}
                  className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 px-4 py-3 text-sm font-bold text-white shadow-md shadow-indigo-900/30 transition-all hover:from-indigo-500 hover:to-violet-500"
                >
                  <Sparkles className="h-4 w-4" />
                  Register
                </Link>
      ...
      <footer className="mt-16 bg-slate-950 text-slate-400">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            ...
            <div>
              ...
              <p className="max-w-md text-sm leading-6 text-slate-400">
                Welcome to our 2D and 3D Lottery Management System.
                Check the latest results, explore result history, and
                manage your lottery account with ease.
              </p>
            </div>
          ...
          <div className="mt-10 flex flex-col gap-3 border-t border-slate-800 pt-6 text-center text-sm text-slate-500 md:flex-row md:items-center md:justify-between md:text-left">
            <p>
              © {new Date().getFullYear()} LotteryPlay. All rights
              reserved.
            </p>
