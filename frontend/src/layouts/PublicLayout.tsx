        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-lg">Lottery</h1>
      ...
      <footer className="bg-gray-900 text-gray-300 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="text-white font-bold text-lg mb-3">2D Lottery</h3>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <Link to="/results-history" className="block hover:text-white">
                  Results History
                </Link>
            ...
            <div>
              ...
              <p className="text-sm mt-2">Email: admin@lottery.com</p>

              <p className="text-sm mt-2">Yangon, Myanmar</p>
            </div>
          </div>
